...
const char s_greetings1[] PROGMEM = "Test ";
const char s_greetings2[] PROGMEM = "print to ";
const char s_greetings3[] PROGMEM = "display";
const char s_greetings4[] PROGMEM = "function";
